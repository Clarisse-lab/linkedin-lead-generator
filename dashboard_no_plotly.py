...
default_webhook = st.secrets.get("WEBHOOK_URL", "https://n8n.srv845413.hstgr.cloud/webhook-test/linkedin-search")
...
with tab3:
    ...
    if st.session_state.leads_data:
        # Estatísticas simples sem gráficos
        potencial_counts = {
        ...
        # Mostrar estatísticas em formato de tabela
